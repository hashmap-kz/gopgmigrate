...
#
# gopgmigrate install script
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/hashmap-kz/gopgmigrate/master/scripts/install.sh | sh
#   
#   curl -fsSL https://raw.githubusercontent.com/hashmap-kz/gopgmigrate/master/scripts/install.sh \
#    | GOPGMIGRATE_VERSION=v0.0.1 GOPGMIGRATE_INSTALL_DIR=/opt/gopgmigrate/bin sh
#
#   wget -qO- https://raw.githubusercontent.com/hashmap-kz/gopgmigrate/master/scripts/install.sh | sh
#
# Environment:
#   GOPGMIGRATE_VERSION       Release tag to install (default: latest)
#   GOPGMIGRATE_INSTALL_DIR   Install directory (default: /usr/local/bin, ignored on Windows)
#
# Requires: curl or wget, tar
#

REPO="hashmap-kz/gopgmigrate"
BIN="gopgmigrate"
...
if [ "$OS" = "windows" ]; then
    ...
    DEST="${GOPGMIGRATE_INSTALL_DIR:-/usr/local/bin}"
    BIN_FILE="$BIN"
