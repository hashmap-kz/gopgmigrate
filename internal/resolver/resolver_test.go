...
func TestGetFiles(t *testing.T) {
	...
	// Run getFiles
	files, err := GetFiles(tmpDir, version.VersionedMigrationRegexDo(), map[string]*regexp.Regexp{})
	if err != nil {
...
func TestCheckFilesAreUniqueByVersion(t *testing.T) {
	...
	files = append(files, version.MigrationFile{Base: "00001-duplicate.do.sql", Path: "/migrations/00001-duplicate.do.sql", Vers: 1})
	err = checkFilesAreUniqueByVersion(files)
	if err == nil {
